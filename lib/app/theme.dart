...
class AppTheme {
  static const Color cBg = Color(0xFFF8FAFC);
  static const Color cSurface = Color(0xFFFFFFFF);
  static const Color cEdge = Color(0xFFE2E8F0);
  static const Color cAccent = Color(0xFF3B82F6);
  static const Color cAccent2 = Color(0xFF93C5FD);
  static const Color cInk = Color(0xFF1E3A8A);
